...
const ProductCard = ({ p }) => {
  ...
  return (
    <div className="w-full sm:w-72 relative bg-[#1A1A1A] rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="p-4">
        ...
        <p className="mb-3 text-sm text-[#CFCFCF] line-clamp-2">
